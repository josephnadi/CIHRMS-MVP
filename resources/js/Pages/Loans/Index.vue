    ...
    <div data-page-root="true">
            ...
            <SlidePanel :open="showProducts" title="Loan products" size="lg"
                ...
                <div class="p-4 space-y-4">
                    ...
                    <div class="rounded-xl border border-outline-variant/50 overflow-x-auto">
                    ...
                    <form @submit.prevent="submitProduct" class="rounded-xl border border-outline-variant/50 p-4 space-y-3 bg-surface-container-low/30">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div><label class="text-[10.5px] font-bold text-on-surface-variant uppercase tracking-wider">Code</label><input v-model="productForm.code" aria-label="Product code" maxlength="30" required class="w-full mt-1 rounded-lg border border-outline-variant bg-surface-container-lowest px-3 py-2 font-mono uppercase text-[12px]" /><InputError :message="productForm.errors.code" /></div>
                            <div><label class="text-[10.5px] font-bold text-on-surface-variant uppercase tracking-wider">Name</label><input v-model="productForm.name" aria-label="Product name" maxlength="120" required class="w-full mt-1 rounded-lg border border-outline-variant bg-surface-container-lowest px-3 py-2 text-[12px]" /><InputError :message="productForm.errors.name" /></div>
                            ...
                            </select><InputError :message="productForm.errors.type" /></div>
                            ...
                            </select><InputError :message="productForm.errors.amortization_method" /></div>
                            <div><label class="text-[10.5px] font-bold text-on-surface-variant uppercase tracking-wider">Min amount (GHS)</label><input v-model.number="productForm.min_amount" aria-label="Minimum loan amount (GHS)" type="number" step="0.01" required class="w-full mt-1 rounded-lg border border-outline-variant bg-surface-container-lowest px-3 py-2 text-[12px]" /><InputError :message="productForm.errors.min_amount" /></div>
                            <div><label class="text-[10.5px] font-bold text-on-surface-variant uppercase tracking-wider">Max amount (GHS)</label><input v-model.number="productForm.max_amount" aria-label="Maximum loan amount (GHS)" type="number" step="0.01" required class="w-full mt-1 rounded-lg border border-outline-variant bg-surface-container-lowest px-3 py-2 text-[12px]" /><InputError :message="productForm.errors.max_amount" /></div>
                            <div><label class="text-[10.5px] font-bold text-on-surface-variant uppercase tracking-wider">Min term (months)</label><input v-model.number="productForm.min_term_months" aria-label="Minimum term in months" type="number" min="1" max="360" required class="w-full mt-1 rounded-lg border border-outline-variant bg-surface-container-lowest px-3 py-2 text-[12px]" /><InputError :message="productForm.errors.min_term_months" /></div>
                            <div><label class="text-[10.5px] font-bold text-on-surface-variant uppercase tracking-wider">Max term (months)</label><input v-model.number="productForm.max_term_months" aria-label="Maximum term in months" type="number" min="1" max="360" required class="w-full mt-1 rounded-lg border border-outline-variant bg-surface-container-lowest px-3 py-2 text-[12px]" /><InputError :message="productForm.errors.max_term_months" /></div>
                            <div><label class="text-[10.5px] font-bold text-on-surface-variant uppercase tracking-wider">Annual rate (0–1)</label><input v-model.number="productForm.annual_interest_rate" aria-label="Annual interest rate (decimal between 0 and 1)" type="number" step="0.0001" min="0" max="1" required class="w-full mt-1 rounded-lg border border-outline-variant bg-surface-container-lowest px-3 py-2 text-[12px]" /><InputError :message="productForm.errors.annual_interest_rate" /></div>
                            <div><label class="text-[10.5px] font-bold text-on-surface-variant uppercase tracking-wider">Max DTI ratio</label><input v-model.number="productForm.max_dti_ratio" aria-label="Maximum debt-to-income ratio" type="number" step="0.01" min="0" max="1" class="w-full mt-1 rounded-lg border border-outline-variant bg-surface-container-lowest px-3 py-2 text-[12px]" /><InputError :message="productForm.errors.max_dti_ratio" /></div>
                            <div><label class="text-[10.5px] font-bold text-on-surface-variant uppercase tracking-wider">Approvals required</label><input v-model.number="productForm.approvals_required" aria-label="Number of approvals required" type="number" min="1" max="5" required class="w-full mt-1 rounded-lg border border-outline-variant bg-surface-container-lowest px-3 py-2 text-[12px]" /><InputError :message="productForm.errors.approvals_required" /></div>
                            <div><label class="text-[10.5px] font-bold text-on-surface-variant uppercase tracking-wider">Effective from</label><input v-model="productForm.effective_from" aria-label="Effective-from date" type="date" required class="w-full mt-1 rounded-lg border border-outline-variant bg-surface-container-lowest px-3 py-2 text-[12px]" /><InputError :message="productForm.errors.effective_from" /></div>
                            <div><label class="text-[10.5px] font-bold text-on-surface-variant uppercase tracking-wider">Effective to</label><input v-model="productForm.effective_to" aria-label="Effective-to date" type="date" class="w-full mt-1 rounded-lg border border-outline-variant bg-surface-container-lowest px-3 py-2 text-[12px]" /><InputError :message="productForm.errors.effective_to" /></div>
                        </div>
                        ...
                        <div><label class="text-[10.5px] font-bold text-on-surface-variant uppercase tracking-wider">Description</label><textarea v-model="productForm.description" aria-label="Product description" rows="2" class="w-full mt-1 rounded-lg border border-outline-variant bg-surface-container-lowest px-3 py-2 text-[12px]" /><InputError :message="productForm.errors.description" /></div>
