                ...
                <div class="flex flex-wrap items-center justify-between gap-4">
                    <div>
                        <div class="flex items-center gap-2 mb-1">
                            <span class="material-symbols-outlined text-[16px] text-secondary" style="font-variation-settings:'FILL' 1">analytics</span>
                            <p class="text-[10px] font-black uppercase tracking-[0.18em] text-secondary/80">REPORTS LEDGER</p>
                        </div>
                        <h1 class="text-[1.6rem] font-black tracking-tight text-primary leading-tight">Reports</h1>
                        <p class="mt-1 text-[13px] font-medium text-on-surface-variant">
                            Statutory returns and operational dashboards — compiled live, exported as audit-trail XLSX.
                        </p>
                    </div>
                    <div class="flex items-center gap-1.5 rounded-full border border-outline-variant/40 bg-surface-container-lowest px-3 py-1.5">
                        ...
                        <span class="text-[10px] font-black uppercase tracking-widest text-on-surface-variant">{{ (reportTypes?.length ?? 0) }} exports available</span>
                    </div>
                </div>
            </Teleport>
