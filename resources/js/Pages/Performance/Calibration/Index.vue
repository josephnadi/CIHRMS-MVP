                ...
                <div class="flex flex-wrap items-center justify-between gap-4">
                    <div>
                        <div class="flex items-center gap-2 mb-1">
                            <span class="material-symbols-outlined text-[16px] text-secondary" style="font-variation-settings:'FILL' 1">tune</span>
                            <p class="text-[10px] font-black uppercase tracking-[0.18em] text-secondary/80">CALIBRATION ROOM</p>
                        </div>
                        <h1 class="text-[1.6rem] font-black tracking-tight text-primary leading-tight">Calibration Sessions</h1>
                        <p class="mt-1 text-[13px] font-medium text-on-surface-variant">
                            HR-led moderation against 20 / 65 / 15 force-distribution — surface outliers, lock for adjustment, then apply.
                        </p>
                    </div>
                    <div class="flex items-center gap-2">
                        <button v-if="canFacilitate" @click="showAddPanel = true"
