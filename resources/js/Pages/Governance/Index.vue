                ...
                <div class="flex flex-wrap items-center justify-between gap-4">
                    <div>
                        <div class="flex items-center gap-2 mb-1">
                            ...
                            <p class="text-[10px] font-black uppercase tracking-[0.18em] text-secondary/80">GOVERNANCE &amp; POLICY</p>
                        </div>
                        <h1 class="text-[1.6rem] font-black tracking-tight text-primary leading-tight">Governance</h1>
                        <p class="mt-1 text-[13px] font-medium text-on-surface-variant">
                            Published policies, professional certifications, and staff acknowledgements on file.
                        </p>
                    </div>
