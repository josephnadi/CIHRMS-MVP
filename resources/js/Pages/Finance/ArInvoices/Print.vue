...
<template>
    ...
    <div class="invoice-page">
        ...
        <div class="no-print toolbar">
            <Link :href="route('finance.ar-invoices.show', invoice.id)" class="btn-link">← Back</Link>
        ...
        <article class="sheet">
            ...
            <section class="parties">
                <div>
                    ...
                    <p class="muted">{{ invoice.customer?.code }}</p>
                </div>
                <div class="dates">
                    ...
                    <p v-if="invoice.customer_invoice_no"><span class="label">Your ref</span> {{ invoice.customer_invoice_no }}</p>
                </div>
            </section>
            ...
            <section class="totals">
                ...
                <div class="row" v-if="invoice.amount_received"><span>Received</span><span>{{ cedi(invoice.amount_received) }}</span></div>
                <div class="row" v-if="invoice.outstanding"><span>Outstanding</span><span>{{ cedi(invoice.outstanding) }}</span></div>
            </section>
