...
class PostingAccountSeeder extends Seeder
{
    ...
    private const RULES = [
        ...
        ['settlement.gratuity_expense',         '5130', 'offboarding', 'Gratuity on a final settlement',           false],
        ['settlement.severance_expense',        '5131', 'offboarding', 'Severance (Act 651 §31) on a settlement', false],
        ['settlement.leave_encashment_expense', '5132', 'offboarding', 'Leave encashment on a final settlement',   false],
        ['settlement.thirteenth_month_expense', '5133', 'offboarding', 'Pro-rated 13th-month on a settlement',     false],
        ['settlement.ex_gratia_expense',        '5134', 'offboarding', 'Ex-gratia on a final settlement',         false],
